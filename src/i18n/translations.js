...
export const translations = {
  en: {
    ...
    badgeAfterHoursEmergency: "After hours emergency",
    badgeEmergencyOnPhone: "Emergency on the phone",
    filterHospitalization: "Hospitalization",
    clinicsFound: "found",
    closed: "Closed",
    publicHolidays: "Public holidays",
    regularHoursHeading: "Ordinary Opening Hours",
    emergencyHoursHeading: "Emergency",
    ...
    menuAboutText: "Not sure which vet to trust with your rabbit? Whether it's a routine checkup or your rabbit needs urgent care, this directory helps you find a vet who actually knows rabbits — so your little friend gets the care they deserve.",
  ...
  cs: {
    ...
    filterByRegion: "Filtrovat",
    distanceLabel: "Vzdálenost",
    distanceAny: "Libovolná",
    openNowFilter: "Otevřeno nyní",
    backToTopLabel: "Nahoru",
    address: "Adresa",
    phone: "Telefon",
    website: "Web",
    ...
    badgeAfterHoursEmergency: "Pohotovost po otevírací době",
    badgeEmergencyOnPhone: "Pohotovost na telefonu",
    filterHospitalization: "Hospitalizace",
    clinicsFound: "nalezeno",
    closed: "Zavřeno",
    publicHolidays: "Svátky",
    regularHoursHeading: "Běžná otevírací doba",
    emergencyHoursHeading: "Pohotovost",
