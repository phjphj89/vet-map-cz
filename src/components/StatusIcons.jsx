...
// A crown, for the "Top pick" / Recommended badge.
export function CrownIcon({ size = 13 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
// The Petsestra plus/cross mark, provided as reference, for the
// "Petsestra works at this clinic" badge. Same stroke style as the icon
// as given (fill="none", stroke="currentColor"), just resized to match
// the rest of the site's small inline badge icons.
